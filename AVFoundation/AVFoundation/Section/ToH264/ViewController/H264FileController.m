//
//  H264FileController.m
//  AVFoundation
//
//  Created by shenghuihan on 16/7/2.
...
@interface H264FileController () <AVCaptureVideoDataOutputSampleBufferDelegate>

@end

@implementation H264FileController
{
